...
class Extend_Warranty_Block_System_Config_Orders_Button extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<td class="value">';
        $html .= '<button title="Save Config" id="extend_sync_products" type="button" class="scalable save" onclick=\'syncOrders("' . $this->getUrl('adminhtml/sync_orders/sync') . '")\'><span>Sync Orders</span></button>';
