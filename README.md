<p align="center">
  ...
  <h1 align="center">Extend - Magento M1 Module</h1>
</p>
...
## Version Support
- The module is built for Magento 1 versions: 
    - Magento 1.0 - 1.9.x
...
- Safari Mobile for iPad, iPad Mini, iPad with Retina Display (iOS 7 or later), for desktop storefront
...
## Not Supported
- The Extend module does not support virtual or downloadable Magento products without customization
